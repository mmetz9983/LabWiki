...
## Set Order of Calculated Fields

In order to ensure proper calculation after you have implemented a calculation script, you need to also check the calculation order.

1. Open Prepare a Form in Adobe
1. Click the three dots `...` next to `Fields`
1. Click `Set field calculation order`
1. Adjust the order of the calculated fields
   - Individual column calculations should come BEFORE total point calculated fields and total score calculated fields

![Calculation Order](images/calculationOrder.png)
